...
const products = [
  {
    ...
    tag: 'Mais Desejada',
    image: '/assets/2144c9f9-15f9-4d80-9d00-0606298c18e3.webp',
  ...
  },
  {
    ...
    tag: 'Peça Autoral',
    image: '/assets/1367b70a-2e2b-4450-9363-7f5747dd4c5b.webp',
  ...
  },
  {
    ...
    image: '/assets/7a32c0b8-1043-4fc2-b303-ffbbb903da48.webp',
  ...
  },
  {
    ...
    image: '/assets/ca4c3fd8-adf7-4f15-ae19-098b5692dc62.webp',
  ...
  },
  {
    ...
    image: '/assets/f409184a-11d9-41ac-b5c1-d562ddd6a74e.webp',
  ...
  },
  {
    ...
    categoryName: 'Presentes',
    tag: 'Edição Especial',
    image: '/assets/{58790E37-25D8-4BA8-A8DF-50D90D446D69}.webp',
  ...
  return (
    <section id="galeria" className="py-12 sm:py-24 bg-gradient-to-b from-[#faf8f5] via-[#f7edf3] to-[#faf8f5] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Instagram See More Button */}
        <FadeUp delay={0.1} yOffset={16} className="mt-10 sm:mt-14 text-center">
          <a
            href="https://www.instagram.com/gisela_arranjos_kokedamas/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#dc288b] via-[#f75bb6] to-[#8e2038] hover:opacity-95 text-white font-extrabold text-base sm:text-lg py-4 px-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
          >
            ...
            <span>Ver Mais Peças no Instagram</span>
          </a>
        </FadeUp>
